...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  <head>
    <title>Did You Mean</title>
 	...
 	<body>
	 	<form action="didYouMeanSearch.html" method="get">
	 	...
	 	<c:if test="${not empty result.suggestedQuery}">
		 	<p>
		 		<span class="didYouMean">Did you mean:</span>
		 		<a href="<c:out value="didYouMeanSearch.html?query=${result.suggestedQuery}"/>"><c:out value="${result.suggestedQuery}"/></a>
		 	</p>	 			
	 	</c:if>
